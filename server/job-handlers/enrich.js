    ...
    if (song.metadata_source !== "手动" || payload.approved) {
      ...
      await saveSongMetadata(
        ...
        song.id,
        {
          ...
          artist: meta.artist,
          tags: JSON.stringify(
            song.tags_manual ? JSON.parse(song.tags) : meta.tags,
          ),
          metadata_source: payload.approved ? "手动" : "AI",
          needs_review: 0,
