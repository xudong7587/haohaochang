...
public class UpdatePolicyTest {
  @Test
  public void versionedAssetsMatchTheSelectedReleaseAndExcludeDebug() {
  ...
  public void versions() {
    assertTrue(UpdatePolicy.newer("0.4.4.1", "0.4.4"));
    assertTrue(UpdatePolicy.newer("0.4.5", "0.4.4.9"));
    assertTrue(UpdatePolicy.newer("0.4.4.10", "0.4.4.2"));
    assertFalse(UpdatePolicy.newer("0.4.4", "0.4.4.1"));
    assertEquals(3, UpdatePolicy.assetPriority("haohaochang-tv-v0.4.4.1.apk", "v0.4.4"));
    assertEquals("0.4.4.1", UpdatePolicy.assetVersion("haohaochang-tv-v0.4.4.1.apk", "v0.4.4"));
    assertEquals(0, UpdatePolicy.assetPriority("haohaochang-tv-v0.4.5.1.apk", "v0.4.4"));
  ...
  public void downloadHosts() {
    ...
    assertFalse(
        UpdatePolicy.allowed(
            "https://github.com@evil.com/xudong7587/haohaochang/releases/download/v1/a.apk", true));
